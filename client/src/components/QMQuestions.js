...
import { endQuiz } from '../reducers/qm/room';
...
const QMQuestions = () => {
  ...
  return (
    <Container className="top-anxiety">
      ...
      <Row>
        <Col>
          <h1 style={{ textAlign: 'center' }}>Room Code : {code}</h1>
        </Col>
      </Row>
      ...
      <Row>
        <Col className="top-anxiety">
          <Button className="secondary" onClick={() => dispatch(endQuiz(code))}>
            End Quizz
          </Button>
        </Col>
      </Row>
