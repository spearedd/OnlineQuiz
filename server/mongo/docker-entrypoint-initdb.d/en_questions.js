...
const uri = "mongodb+srv://spearedd3:quizzer1@quizzer.btvscc0.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
	try {
		...
		await client.db("quizzer").command({ ping: 1 });
		console.log("Pinged your deployment. You successfully connected to MongoDB!");
	} finally {
		// Input data
		await client.db("test").collection("questions").insertMany([
			{
